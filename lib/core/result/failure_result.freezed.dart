...
abstract class $FailureResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({FailureReasons reason, String debugMessage, String? errorMessage});
}
...
class _$FailureResultImpl implements _FailureResult {
  const _$FailureResultImpl(
      {required this.reason, required this.debugMessage, this.errorMessage});
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, reason, debugMessage, errorMessage);
...
abstract class _FailureResult implements FailureResult {
  const factory _FailureResult(
      ...
      final String? errorMessage}) = _$FailureResultImpl;
