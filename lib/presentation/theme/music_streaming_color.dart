...
@immutable
class MusicStreamingColor extends Color implements WidgetStateProperty<Color> {
  const MusicStreamingColor(
    super.value, {
    Color? light,
    Color? dark,
    Color? hover,
...
extension Up4DateColorExtensions on MusicStreamingColor {
  MusicStreamingColor lerp(MusicStreamingColor? other, double t) {
    return MusicStreamingColor(
