...
abstract class $UserViewModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String name, GenderType gender, DateTime birthday, List<String> photos});
}
...
class _$UserViewModelImpl extends _UserViewModel {
  ...
  @override
  String toString() {
    return 'UserViewModel(name: $name, gender: $gender, birthday: $birthday, photos: $photos)';
  }
...
abstract class _UserViewModel extends UserViewModel {
  const factory _UserViewModel(
      ...
      required final List<String> photos}) = _$UserViewModelImpl;
